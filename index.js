...
RNSecp256k1.raw_sign = async function (data, priv) {
  ...
  return RNSecp256k1.base64_decode(bSignature);
};
...
RNSecp256k1.raw_privKeyTweakMul = async function (priv, tweak) {
  ...
  return RNSecp256k1.base64_decode(bResult);
};
